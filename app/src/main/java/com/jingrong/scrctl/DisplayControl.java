...
public final class DisplayControl {
    ...
    static {
        ...
        try {
            ...
            Log.e("DisplayControl", "Could not initialize: " + e.getMessage());
        }
    ...
    public static IBinder getPhysicalDisplayToken(long physicalDisplayId) {
        try {
            ...
            Log.e("DisplayControl", "getPhysicalDisplayToken failed: " + e.getMessage());
            return null;
        }
    }
    ...
    public static long[] getPhysicalDisplayIds() {
        try {
            ...
            Log.e("DisplayControl", "getPhysicalDisplayIds failed: " + e.getMessage());
            return null;
        }
    }
